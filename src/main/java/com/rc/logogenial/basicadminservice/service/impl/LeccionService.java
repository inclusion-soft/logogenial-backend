...
//    @Override
//    public ResultSearchData<Leccion> Search(PageablePrimitive pag, int grupoNivelId) {
//
...
//        Page<Leccion> pagedResult = repository.findAllByGrupoNivel_Id(paging, grupoNivelId);
//        return (ResultSearchData<Leccion>) this.getResultSearch(pagedResult);
//    }
}
